...
ifneq ($(filter angler begonia raphael enchilada lavender mido wayne whyred platina ginkgo vince twolip beryllium violet X00T RMX1801 tissot x2 jasmine_sprout sirius grus kenzo davinci,$(du_device)),)
scr_resolution := 1080
endif
